...
public class Sniper extends Weapon
{
	...
	public static final float BULLET_SPEED = 5000f;
	// Bulletspeed +- BUTTET_RANDOM_SPEED
	public static final float BUTTET_RANDOM_SPEED = 500f;
	public static final float SPRAY = 0.1f;
	public static final float BULLET_SIZE = 15f;
	public static final int BULLET_DMG = 200;

	public static final int BULLET_LIVE_TIME = 10000;
	public static final int BULLET_LIVE_TIME_RANDOM = 1000;

	public static final int AMMUNTION_MAX = 5;
	public static final int RELOAD_TIME = 2500;
